...
def main():
	...
	idtree = dtree()
	data, classes, featureNames = idtree.read_data(filename)
	...
	feature = np.shape(featureNames)[0]
	feature_entropy = []
	feature_gini = []
	for i in range(feature):
		featEntropy, featGini = idtree.calc_info_gain(data, classes, i)
		feature_entropy = np.append(feature_entropy, featEntropy)
	entorpy_of_features = dict(zip(featureNames,feature_entropy))
	print feature_entropy ,"\n"
	print entorpy_of_features
